...
class _SelectFolderPageState extends State<SelectFolderPage> {
  ...
  late List<bool> folderIsChecked;

  @override
  void initState() {
    folderIsChecked = List<bool>.filled(_FavoriteFolderPageController.folderName.length, false);
    super.initState();
  }
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      print(_FavoriteFolderPageController.folderRestaurant[0]);
