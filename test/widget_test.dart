...
class NaverMapPageController extends GetxService {
  ...
  RxBool RawAbstractRestaurantDataLoading = false.obs;
  ...
  // process 10개씩
  Future<void> processRawAbstractRestaurantDataForSearch(context) async {

    RawAbstractRestaurantDataLoading.value = true;
    ...
    print('총 marker 개수: ${loadingMarkers.length}');
    print('================================================================');

    getMoreAbstractRestaurantData.value = true;

    markers.addAll(loadingMarkers);
    RawAbstractRestaurantDataLoading.value = false;
  }

  // process 10개씩
  Future<void> processRawAbstractRestaurantDataForMarker(context) async {
